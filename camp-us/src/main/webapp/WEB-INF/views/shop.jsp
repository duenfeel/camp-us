...
<html lang="en">
  ...
  <div class="site-wrap">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="/resources/index.html" class="js-logo-clone">Shoppers</a>
              </div>
            </div>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="/resources/index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Shop</strong></div>
        </div>
      </div>
    </div>
              ...
              <div class="col-md-12 mb-5">
                ...
                <div class="d-flex">
                 <div class=" mr-1 ml-md-auto">
                    <button type="button" class="btn form-control border-0" id="dropdownMenuOffset">
                      상품등록
                    </button>
                  </div>
                  <div class="btn-group">
                    <button type="button" class="btn btn-secondary btn-sm dropdown-toggle" id="dropdownMenuReference" data-toggle="dropdown">최신순</button>
          ...
          <div class="col-md-3 order-1 mb-5 mb-md-0">
            <div class="border p-4 rounded mb-4">
              ...
              <ul class="list-unstyled mb-0">
                <li class="mb-1"><a href="#" class="d-flex"><span>Camping</span> <span class="text-black ml-auto">(2,220)</span></a></li>
                <li class="mb-1"><a href="#" class="d-flex"><span>Backpacking</span> <span class="text-black ml-auto">(2,550)</span></a></li>
                <li class="mb-1"><a href="#" class="d-flex"><span>Picnic</span> <span class="text-black ml-auto">(2,124)</span></a></li>
              </ul>
            </div>
                </div>
