...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover" style="background-image: url(/resources/images/title.png);" data-aos="fade">
      <div class="container">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <a class="block-2-item" href="#">
              <figure class="image">
                <img src="/resources/images/Backpacking.png" alt="" class="img-fluid">
              </figure>
              <div class="text">
                <span class="text-uppercase">Collections</span>
                <h3>Backpacking</h3>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                ...
                <li class="phone"><a href="tel://23923929210">+82 01-0000-0000</a></li>
